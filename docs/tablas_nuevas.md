...
INSERT INTO areas (nombre, descripcion, color_hex, orden_visualizacion, activa) VALUES
...
COMMENT ON TABLE areas IS 'Campos de vida donde Guillermo desarrolla proyectos';

-- ============================================
-- TABLA: motivos
-- ============================================

INSERT INTO motivos (nombre, descripcion, icono, peso_personal) VALUES
...
COMMENT ON TABLE motivos IS 'Motivaciones que impulsan a Guillermo a llevar adelante proyectos';
...
COMMENT ON TABLE misiones IS 'Roles de vida y propósitos de Guillermo a largo plazo';